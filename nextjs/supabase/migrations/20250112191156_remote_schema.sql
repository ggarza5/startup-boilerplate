...
drop policy "Can insert own results data." on "public"."results";

drop policy "Can only view own results data." on "public"."results";

drop policy "Users can delete their own sections" on "public"."sections";

drop policy "Users can insert their own sections" on "public"."sections";

drop policy "Users can update their own sections" on "public"."sections";

drop policy "Users can view their own sections" on "public"."sections";

alter table "public"."sections" drop constraint "sections_created_by_fkey";

create table "public"."customers" (
    "id" uuid not null,
    "stripe_customer_id" text,
    "Time Created" timestamp with time zone default now()
);
...
alter table "public"."sections" drop column "created_by";
...
CREATE TRIGGER on_join_email_list AFTER INSERT ON public.email_list FOR EACH ROW EXECUTE FUNCTION supabase_functions.http_request('https://wlgwpaxthypkrtwkcdlk.supabase.co/functions/v1/on_join_email_list', 'POST', '{"Content-type":"application/json"}', '{"type":"email"}', '1000');
