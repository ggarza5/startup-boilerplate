...
const IndexPage: React.FC = () => {
  ...
  const [isCreatingSection, setIsCreatingSection] = useState(false); // Track section creation state
  ...
  const handleSelectSection = async (sectionName: string, sectionId: string) => { // Change parameter type to string
    ...
    setIsCreatingSection(true); // Set creating section state
    try {  
      ...
      setIsCreatingSection(false); // Reset creating section state
    }
  };
